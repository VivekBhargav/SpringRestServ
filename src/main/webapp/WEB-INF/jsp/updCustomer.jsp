...
<br/>
<br/>
<h2 align="center" style="color: green">Update Customer</h2>
	<form:form modelAttribute="customer" cssClass="form-horizontal"
		action="updCustomer" method="post">
		<div class="form-group">
			<label for="custID" class="col-sm-2 control-label">Enter Customer ID: </label>
			<div class="col-sm-10">
